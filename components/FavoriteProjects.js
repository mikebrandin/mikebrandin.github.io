...
export default function FavoriteProjects() {
  return (
    <div className="bg-[#e3e3e3] -mt-40 dark:bg-gray-900">
      <div className="max-w-6xl mx-auto">
        <header className="flex flex-col md:flex-row justify-between items-center pt-40 mx-10 md:my-20 lg:my-0">
          <h1 className="text-6xl lg:text-9xl max-w-lg font-bold text-gray-50 my-20 md:my-15 md:text-white dark:text-gray-600 text-center">
            Favorite Projects
          </h1>
          <Link
            href="/projects"
